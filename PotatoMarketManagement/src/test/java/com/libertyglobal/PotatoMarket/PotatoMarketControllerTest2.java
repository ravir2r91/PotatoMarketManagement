...
/**
 * Test for checking happy path flow of POST method.
 * @author Rabindra Rakshit
 *
 */

public class PotatoMarketControllerTest2 {
	@Autowired
	private MockMvc mvc;
	...
	@Test 
	public void addPotatoBagHappyPath() throws Exception {
        PotatoBag potatoBag = new PotatoBag(Long.parseLong("1"),5,"Owel",LocalDateTime.now(),34);
