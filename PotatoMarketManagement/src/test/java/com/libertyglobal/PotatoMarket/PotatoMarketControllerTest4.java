...
/**
 * Test for checking valid size while inserting new Potato Bags
 * 
 * @author Rabindra Rakshit
 *
 */

public class PotatoMarketControllerTest4 {
	@Autowired
	private MockMvc mvc;
	...
	@Test 
	public void addPotatoBag_validateSizeRange() throws Exception {
        PotatoBag potatoBag = new PotatoBag(Long.parseLong("1"),500,"Owel",LocalDateTime.now(),34);
